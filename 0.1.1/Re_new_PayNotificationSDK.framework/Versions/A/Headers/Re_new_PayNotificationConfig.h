//
//  Re_new_PayNotificationConfig.h
//  PayNotificationSDK
//
...
@interface Re_new_PayNotificationConfig : NSObject
...
- (void)re_new_initPayNotificationConfigWith:(BOOL)isDebug withClientID:(NSString *)clientID withSignatureKey:(NSString *)signatureKey withDesKey:(NSString *)desKey appid:(NSString *)appId;
